<?php $link = sprintf('https//%s/%s/confirm/%d/%s', $conf->get('base_host'), $name, $shop_id, $token); ?>
<p>Hi there,</p>

<p>Your email address was used to place an order at the store <a href="<?php print sprintf('https//%s/%s', $conf->get('base_host'), $name); ?>"><?php print $name; ?></a> hosted at <a href="http://<?php print $conf->get('base_host'); ?>">canistro, your personal e-commerce</a>.</p>
